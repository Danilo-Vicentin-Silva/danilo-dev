  ...
  return (
    <section id="contato" className="py-24 bg-background">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <span className="text-primary text-sm font-medium uppercase tracking-wider">{t.contact.sectionTitle}</span>
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2">{t.contact.title}</h2>
          <p className="text-foreground/60 mt-4 max-w-xl mx-auto">{t.contact.description}</p>
        </div>

        {/* Social links */}
        <div ref={cardsRef} className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto mb-16">
          {socialLinks.map((social, index) => (
            ...
            >
              ...
              <h3 className="text-foreground font-semibold mb-1">{social.name}</h3>
        ...
        >
          ...
          <h3 className="text-2xl md:text-3xl font-bold text-primary-foreground mb-4">{t.contact.cta.title}</h3>
          <p className="text-primary-foreground/80 mb-8 max-w-lg mx-auto">{t.contact.cta.description}</p>
          <Button
            asChild
            size="lg"
